  ...
  return (
    <div className="w-full">
      <div className="relative">
        <button
          className="absolute z-10 disabled:opacity-0 disabled:cursor-not-allowed shadow-lg bg-gray-500 rounded-full border border-gray-600 text-white -left-5 top-1/2"
          ref={prevRef}
        >
